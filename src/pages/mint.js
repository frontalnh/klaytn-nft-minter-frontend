...
const ACCOUNT3_ADDRESS = "0x9fD18ddAD90352AB2a262C6C66b01e366F56e9f4";
...
const Mint = (props) => {
  ...
  const formSubmit = () => {
    ...
    const data = caver.klay.abi.encodeFunctionCall(
      ...
      [ACCOUNT3_ADDRESS, caver.utils.toPeb(10, "KLAY")]
    );
    ...
    // console.log(window.klaytn.sendAsync);
    ...
    // );
    // return axios
    //   .post(`${process.env.REACT_APP_BACKEND_URL}/nft/mint`, formData)
    //   .then((res) => {
